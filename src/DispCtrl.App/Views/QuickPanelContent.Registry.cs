...
internal sealed partial class QuickPanelContent
{
    ...
    private FrameworkElement? DeskTile(string id)
    {
        ...
        return id switch
        {
            ...
            // Closes the panel on the way off: left open, the tile's own tooltip
            // stayed bright on top of the black.
            "displaysOff" => Tile(e, () => _vm.DisplaysOff, v => { _vm.DisplaysOff = v; if (v) _dismiss(); },
    ...
    private FrameworkElement?[] DisplaysOffRows(bool inKeepAwake)
    {
        ...
        [
            ...
            EnabledWhen(SwitchRow("Backlight down too", "At 90% and darker: each display that allows it turns its real backlight down, and back as it wakes.",
                    () => _vm.DisplaysOffBacklight, v => _vm.DisplaysOffBacklight = v,
                    nameof(MainViewModel.DisplaysOffBacklight), "QuickDisplaysOffBacklight"),
                () => _vm.DisplaysOffBacklightAvailable, nameof(MainViewModel.DisplaysOffBacklightAvailable)),
