...
/// <summary>
/// Writes everything DisplCtrl can discover about every attached display to one
/// readable text file.
/// </summary>
/// <remarks>
...
public static class DisplayReport
{
    ...
    public static string Build(IReadOnlyList<DisplayInfo> displays)
    {
        ...
        sb.AppendLine("DisplCtrl display report");
    ...
    private static void DescribeEdid(StringBuilder sb, DisplayInfo d)
    {
        ...
        Line(sb, "Manufacturer", e.ManufacturerName.Length > 0
            ...
            : $"{e.ManufacturerCode}  (not a code DisplCtrl has a name for)");
    ...
    private static void DescribeMonitorControls(StringBuilder sb, DisplayInfo d)
    {
        ...
        Line(sb, "DisplCtrl will offer", $"{settable} of them");

        sb.AppendLine();
        sb.AppendLine("    Every code this monitor lists. \"Set\" means DisplCtrl will write it;");
    ...
    /// <summary>Why a control the monitor lists is not one DisplCtrl will write.</summary>
    /// <remarks>
    ...
    /// DisplCtrl: a panel that cannot say which of its own settings it is on has
    ...
    {
        Section(sb, "Controls DisplCtrl can drive");
