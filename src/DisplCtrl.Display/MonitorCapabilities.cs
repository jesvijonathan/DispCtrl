...
public sealed record VcpControl(byte Code, string Name, VcpKind Kind, IReadOnlyList<VcpValue> Values)
{
    ...
    /// <summary>Whether DisplCtrl will offer to change this control.</summary>
    /// <remarks>
    ...
    /// <summary>
    /// The codes DisplCtrl is willing to write.
    /// </summary>
    /// <remarks>
...
/// <para>
/// Controls offered to the user are drawn from this list, so DisplCtrl never shows
...
public static class MonitorCapabilities
{
    ...
    /// <summary>
    /// Reads only the controls DisplCtrl is willing to set.
    /// </summary>
    /// <remarks>
    ...
    /// a capabilities read is the longest conversation DisplCtrl ever has with a
