...
/// in DispCtrl goes through here so that cannot happen again.
/// </para>
/// <para>
...
{
    /// <summary>
    /// One gate per monitor, shared across every DispCtrl process.
    /// </summary>
    /// <remarks>
    ...
    /// single-instance mutex. DispCtrl is per-user; a second user's monitors are
    /// not these monitors.
    /// </para>
    /// </remarks>
    ...
    private static string MutexName(string devicePath)
    {
        ...
        return $"Local\\DispCtrl.Ddc.{hash:x16}";
    }
