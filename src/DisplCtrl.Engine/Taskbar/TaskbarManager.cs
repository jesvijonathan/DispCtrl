...
/// was built against, which is precisely the burn-in case DisplCtrl exists to avoid.
/// </para>
/// </remarks>
internal sealed class TaskbarManager
{
    ...
    private DisplCtrlSettings? _pendingSettings;
    ...
    public TaskbarManager(DisplCtrlSettings settings, bool trace = false)
    {
        _settings = settings;
        _trace = trace;
    }
    ...
    /// </remarks>
    public void ApplySettings(DisplCtrlSettings settings) =>
    ...
    /// </para>
    /// </remarks>
    private void AdoptSettings(DisplCtrlSettings settings)
    {
