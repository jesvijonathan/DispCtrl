...
namespace DisplCtrl.Engine.Shell;

/// <summary>
/// DisplCtrl's icon in the notification area, and what a click on it does.
/// </summary>
/// <remarks>
...
internal sealed class TrayIconService : IDisposable
{
    ...
    private const string ClassName = "DisplCtrl.Tray";
    ...
    public TrayIconService(DisplCtrlSettings settings, Action<DisplCtrlSettings> persist)
    {
        _settings = settings;
        _persist = persist;
    ...
    private unsafe NOTIFYICONDATAW Data()
    {
        ...
        data.szTip = "DisplCtrl - brightness and displays";
    ...
    private unsafe void ShowMenu()
    {
        ...
        try
        {
            ...
            Item(menu, CmdOpen, "Open DisplCtrl");
