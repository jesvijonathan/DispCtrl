...
namespace Umbra.Engine.Taskbar;
...
/// was built against, which is precisely the burn-in case Umbra exists to avoid.
/// </para>
/// </remarks>
internal sealed class TaskbarManager
{
    ...
    private UmbraSettings? _pendingSettings;
    ...
    public TaskbarManager(UmbraSettings settings, bool trace = false)
    {
        _settings = settings;
        _trace = trace;
    }
    ...
    /// </remarks>
    public void ApplySettings(UmbraSettings settings) =>
    ...
    /// </para>
    /// </remarks>
    private void AdoptSettings(UmbraSettings settings)
    {
