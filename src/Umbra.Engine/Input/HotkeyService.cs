...
internal sealed class HotkeyService : IDisposable
{
    ...
    public HotkeyService(UmbraSettings settings, Action<UmbraSettings> persist)
    {
        _settings = settings;
        _persist = persist;
    ...
    private void Act(Hotkey hotkey, UmbraSettings settings)
    {
    ...
    private void Step(Hotkey hotkey, UmbraSettings settings, int delta)
    {
