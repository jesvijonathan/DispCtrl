...
public sealed partial class MainViewModel : INotifyPropertyChanged
{
    ...
    public string EngineDetailText => _status.Running
        ...
        : _engine.EnginePath is null
            ? "Engine executable not found — build DisplCtrl.Engine first."
    ...
    /// and how bright each panel should go, and there is nothing DisplCtrl can read
    ...
    /// <summary>Restores DisplCtrl's own defaults, globally and for every monitor.</summary>
